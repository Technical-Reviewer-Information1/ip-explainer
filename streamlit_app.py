...
def step3_four_shields():
    ...
    tab1, tab2, tab3, tab4 = st.tabs(["① すごい技術を守る", "② クールな見た目を守る", "③ 名前とロゴを守る", "④ 便利な工夫を守る"])
    
    with tab1:
        st.subheader("すごい技術について学ぼう")
        st.write("""
        **「世界初のAI機能」のような、高度な技術的アイデア（発明）を守る権利があります。**
        
        この権利を取得すれば、一定期間その技術を独占できます。スマートフォンや医薬品の多くがこの権利で守られています。
        """)
    ...
    with tab2:
        st.subheader("クールな見た目について学ぼう")
        st.write("""
        **製品の「見た目」、つまり物品の形状や模様、色彩などのデザインを守る権利があります。**
        
        機能は同じでも、見た目が魅力的でなければ売れませんよね。自動車のボディデザインや、ペットボトルの形などがこの権利で守られます。
        """)
        ...
        st.write("デザインがユニークなほど、この権利で守る価値が高まります。")
    
    with tab3:
        st.subheader("名前とロゴについて学ぼう")
        st.write("""
        **『インテリ・ペンシル』という名前やロゴマーク。これは製品やサービスの「顔」です。**
        
        このような商品名やロゴを他人にマネされないように守る権利があります。更新すれば、半永久的に権利を持ち続けることも可能です。
        """)
        
        st.info("💡 コンビニのロゴや商品名、スマートフォンのリンゴのマークなど、街中にはこの権利であふれています！")
    
    with tab4:
        st.subheader("便利な工夫について学ぼう")
        st.write("""
        **「ワンタッチで飛び出す定規」は便利な工夫ですが、AI技術ほど「高度な発明」ではないかもしれません。**
        
        このような物品の形状や構造に関するちょっとしたアイデア（考案）を守る権利があります。「プチ特許」のようなイメージです。
        """)
