(function () {
  ...
  function init() {
    if (document.getElementById('chkBox')) {
      const YS = ['出願から10年', '出願から20年', '出願から25年', '登録から10年（更新できる）'];
      window.Quiz.choice('chkBox', 'chkNote', [
        { k: '特許権', q: '高度な技術的アイデア（発明）を守る権利の保護期間は。', ch: YS, a: 1,
          why: '出願から20年です。新しい技術を一定期間だけ独占させ、そのかわり内容を公開させるしくみです。' },
        { k: '実用新案権', q: '物品の形状・構造などの考案を守る権利の保護期間は。', ch: YS, a: 0,
          why: '出願から10年。特許ほど高度でない工夫を、短い期間・簡単な手続きで守ります。' },
        { k: '意匠権', q: '物品のデザイン（形・模様・色）を守る権利の保護期間は。', ch: YS, a: 2,
          why: '出願から25年で、産業財産権の中では<strong>いちばん長い</strong>期間です。' },
        { k: '商標権', q: '商品やサービスを区別するマーク・名前を守る権利の保護期間は。', ch: YS, a: 3,
          why: '登録から10年ですが、<strong>商標権だけは更新できます</strong>。だから何十年も同じロゴが守られます。' }
      ], '<strong>更新できるのは商標権だけ</strong>、<strong>いちばん長いのは意匠権（25年）</strong>。ここが問われやすいところです。');
    }
